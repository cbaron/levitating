                    ...
                    while ($posts->have_posts()):
                        ...
                        if (has_post_thumbnail($post_id)):
                            ...
                            <li>
                                ...
                                endswitch; ?>
                                <div class="ei-title clearfix">
                                    <h2><a href="<?php echo $post_url; ?>"><?php echo $post_title; ?></a></h2>/                                    <?php /* <h3><?php the_excerpt(); ?></h3> */ ?>
                                </div>
                                <?php 
                                ...
                                <li style="width: 355px;">
                                    <article class="testimonial-item clearfix">
                                        ...
                                        <div class="testimonial-author clearfix">
                                            ...
                                            <a class="author-name" href="<?php echo $author_url; ?>" target="_blank">
                                                <?php the_title(); ?>
                                            </a>
                                            <a href="<?php echo $author_url; ?>" class="author-url" target="_blank">
